          ...
          <div className="inline-flex items-center gap-5">
            ...
            <div>
              ...
              <div className="text-muted-foreground">
                Agency . Jakart, Indonesia . Full-Time
              </div>
            </div>
          </div>
          ...
          <div className="mb-16">
            ...
            <div className="text-muted-foreground">
              <p>
                ...
                Necessitatibus veritatis accusamus, minus consectetur nesciunt
                impedit iusto amet itaque repudiandae, vero modi qui minima non
                nisi dignissimos voluptas eius recusandae voluptates.
              </p>
            </div>
          </div>
          <div className="mb-16">
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex flex-row justify-between">
                ...
                <div className="font-semibold">Juli 20, 2024</div>
              </div>
              <div className="flex flex-row justify-between">
